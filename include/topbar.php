	...
	<div class="agile-main-top">
		<div class="container-fluid">
			<div class="row main-top-w3l py-2">
				...
				<div class="col-lg-10 header-right mt-lg-0 mt-2">
					<!-- header lists -->
					<ul>
						<?php
						...
						?>
						<li class="text-center border-right text-white">
						✧ MIỄN PHÍ VẬN CHUYỂN ĐƠN HÀNG 950K ✧
						</li>
						<li class="text-center border-right text-white">
						...
						<li class="text-center border-right text-white">
						✧  TÚI & HỘP TRANG NHÃ SẴN SÀNG TRAO TẶNG ✧
						</li>
					</ul>
					<!-- //header lists -->
				</div>
						...
						<!-- //search -->
						 ...
						 <div class="col-2 dropdown">
							...
							<div class="dropdown-menu" aria-labelledby="userDropdown">
								<a class="dropdown-item" href="#" data-toggle="modal" data-target="#dangnhap">
									<i class="fas fa-sign-in-alt"></i> Đăng nhập
								</a>
								<a class="dropdown-item" href="#" data-toggle="modal" data-target="#dangky">
